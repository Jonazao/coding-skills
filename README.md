...
*   **Windows (PowerShell)**:
    ```powershell
    irm https://raw.githubusercontent.com/Jonazao/coding-skills/master/dist/technical-assessment-orchestrator/install.ps1 | iex
    ```

*   **macOS / Linux (Bash/Zsh)**:
    ```bash
    curl -fsSL https://raw.githubusercontent.com/Jonazao/coding-skills/master/dist/technical-assessment-orchestrator/install.sh | bash
    ```
...
1. Clone this repository:
   ```bash
   git clone https://github.com/Jonazao/coding-skills.git
   cd coding-skills/dist/technical-assessment-orchestrator
   ```
2. Run the installer:
   * **Windows**: `.\install.ps1`
